   ...
   public:
    ...
    std::shared_ptr<T> AddComponent(ArgsT... args) {
        ...
        message << "Added new component: "
                << std::string(typeid(*newComponent).name()) << " "
                << newComponent;
    ...
    void RemoveComponent(Component* component) {
        ...
        components.erase(
            std::remove_if(components.begin(), components.end(),
                           [component](std::shared_ptr<Component> obj) {
    ...
    void RemoveComponent(std::weak_ptr<Component> component) {
        ...
        message << "Deleting component: "
                << std::string(typeid(componentPtr).name()) << " "
                << componentPtr;
        LOG_INFO(message.str());
        components.erase(
            std::remove_if(components.begin(), components.end(),
                           [componentPtr](std::shared_ptr<Component> obj) {
                               return obj == componentPtr;
                           }),
            components.end());
    }
