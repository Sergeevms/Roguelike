...
namespace MaxrEngine
{
	...
	private:
		...
		void UpdateLocalTransform(const Vector2Df& position, float angle, const Vector2Df& scale) const;
		Matrix2D CreateTransform(const Vector2Df& position, float angle, const Vector2Df& scale) const;
	};
}
