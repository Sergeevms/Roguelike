...
#define LOG_INFO(message)                                                \
    MaxrEngine::LoggerRegister::GetInstance().GetLogger("Global")->Info( \
        message);
#define LOG_WARN(message)                                                \
    MaxrEngine::LoggerRegister::GetInstance().GetLogger("Global")->Warn( \
        message);
#define LOG_ERROR(message)                                                \
    MaxrEngine::LoggerRegister::GetInstance().GetLogger("Global")->Error( \
        message);