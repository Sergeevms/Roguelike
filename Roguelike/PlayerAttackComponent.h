...
namespace Roguelike
{
	class PlayerAttackComponent :
		public AttackComponent, public MaxrEngine::IObserver
	{
	public:
		PlayerAttackComponent(MaxrEngine::GameObject* gameObject, float cooldown = 0.f, float damage = 0.f, float range = 0.f,
