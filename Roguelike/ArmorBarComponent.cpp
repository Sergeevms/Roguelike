...
namespace Roguelike
{
	ArmorBarComponent::ArmorBarComponent(MaxrEngine::GameObject* gameObject, MaxrEngine::Vector2Df centerOffset, MaxrEngine::Vector2Df barSize, float borderSize, sf::Color barColor)
	...
	void ArmorBarComponent::Notify(std::shared_ptr<MaxrEngine::IObservable> observable)
	{
