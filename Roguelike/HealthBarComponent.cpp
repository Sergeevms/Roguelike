...
namespace Roguelike
{
	HealthBarComponent::HealthBarComponent(MaxrEngine::GameObject* gameObject, MaxrEngine::Vector2Df centerOffset, MaxrEngine::Vector2Df barSize, float borderSize, sf::Color barColor)
	...
	void HealthBarComponent::Notify(std::shared_ptr<MaxrEngine::IObservable> observable)
	{
