...
TEST(MatrixTest, MultiplyOperator) {
    ...
    MaxrEngine::Matrix2D matrix2 = MaxrEngine::Matrix2D(
        -50.f, 49.f, 48.f, 47.f, 46.f, -45.f, 44.f, -43.f, 42.f);
...
TEST(MatrixTest, TransformConstructor) {
    ...
    MaxrEngine::Matrix2D matrix =
        MaxrEngine::Matrix2D(zeroVector, 0.f, zeroVector);
    ...
    EXPECT_EQ(nullTransform[1][0], 0.f);
    EXPECT_EQ(nullTransform[1][1], 0.f);
    EXPECT_EQ(nullTransform[1][2], 0.f);
    EXPECT_EQ(nullTransform[2][0], 0.f);
    EXPECT_EQ(nullTransform[2][1], 0.f);
    ...
    EXPECT_EQ(positionTransform[1][0], 0.f);
    EXPECT_EQ(positionTransform[1][1], 0.f);
    EXPECT_EQ(positionTransform[1][2], 3.f);
    EXPECT_EQ(positionTransform[2][0], 0.f);
    EXPECT_EQ(positionTransform[2][1], 0.f);
    ...
    EXPECT_NEAR(angleTransform[1][1], 0.f, EPS);
    EXPECT_NEAR(angleTransform[1][2], 0.f, EPS);
    EXPECT_NEAR(angleTransform[2][0], 0.f, EPS);
    EXPECT_NEAR(angleTransform[2][1], 0.f, EPS);
    ...
    EXPECT_EQ(scaleTransform[1][0], 0.f);
    EXPECT_EQ(scaleTransform[1][1], 3.f);
    EXPECT_EQ(scaleTransform[1][2], 0.f);
    EXPECT_EQ(scaleTransform[2][0], 0.f);
    EXPECT_EQ(scaleTransform[2][1], 0.f);
...
TEST(MatrixTest, Inversed) {
    ...
    MaxrEngine::Matrix2D someMatrix = MaxrEngine::Matrix2D(
        7.f, 3.f, 10.f, 37.f, -30.f, 2.f, 2.f, 19.f, -23.f);
