...
{
	Engine::Vector2Df vectorF(-1.f, 3.f);
...
{
	Engine::Vector2Df vectorF1(-1.f, 3.f);
	Engine::Vector2Df vectorF2(3.f, -1.f);
	Engine::Vector2Df vectorF3(-1.f, 3.f);
...
{
	Engine::Vector2Df vectorF1(-1.f, 4.f);
	Engine::Vector2Df vectorF2(-3.f, -5.f);
	float dotProduct1 = Engine::DotProduct(vectorF1, vectorF2);
...
{
	Engine::Vector2Df vectorF1(-1.f, 3.f);
	Engine::Vector2Df vectorF2 = -vectorF1;
...
TEST(VectorTests, MinusOperator)
{
	Engine::Vector2Df vectorF1(-1.f, 4.f);
	Engine::Vector2Df vectorF2(-3.f, -5.f);
	Engine::Vector2Df vectorF3 = vectorF1 - vectorF2;
	vectorF1 -= vectorF2;
...
{
	Engine::Vector2Df vectorF1(-1.f, 4.f);
	Engine::Vector2Df vectorF2 = vectorF1 * 2.f;
	Engine::Vector2Df vectorF3 = 3.f * vectorF1;
	vectorF1 *= -3.f;
